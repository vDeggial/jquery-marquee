...
methods[options]()}
return}
var attr;$.each(o,function(key){attr=$this.attr("data-"+key);if(typeof attr!=="undefined"){switch(attr){case "true":attr=!0;break;case "false":attr=!1;break}
...
$this.wrapInner("<div style='width:"+totalWidth+"px' class='js-marquee-wrapper'></div>");$marqueeWrapper=$this.find(".js-marquee-wrapper");$marqueeWrapper.css("will-change","transform");switch(verticalDir)
...
{case o.duplicated:switch(verticalDir)
