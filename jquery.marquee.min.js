...
{vertical=vertical||!1;var data=css3AnimationIsSupported?(vertical?_generateCssData("transform",value,"translateY(",")"):_generateCssData("transform",value,"translateX(",")")):(vertical?_generateCssData("margin-top",value):_generateCssData("margin-left",value));element.css(data.property,data.value)};var _rePositionVertically=function(){_setElementCss($marqueeWrapper,(o.direction==="up"?containerHeight+"px":"-"+elHeight+"px"),!0)},_rePositionHorizontally=function(){_setElementCss($marqueeWrapper,(o.direction==="left"?containerWidth+"px":"-"+elWidth+"px"))};switch(!0)
