...
verticalDir=o.direction==="up"||o.direction==="down";o.gap=o.duplicated?parseInt(o.gap):0;$this.wrapInner("<div class='js-marquee'></div>");var $el=$this.find(".js-marquee").css({"margin-right":o.gap,"float":"left"});totalWidth+=($this.width()+1000);if(o.duplicated){$el.clone(!0).appendTo($this);totalWidth*=2}
...
{var data={"property":"","value":""};data.property=property;value=prefix.concat(value,suffix);data.value=value;return data};var _generateAnimationCss=function(value,vertical=!1)
{var data=css3AnimationIsSupported?(vertical?_generateCssData("transform",value,"translateY(",")"):_generateCssData("transform",value,"translateX(",")")):(vertical?_generateCssData("margin-top",value):_generateCssData("margin-left",value));var property=data.property;value=data.value;var obj={};obj[property]=value;return obj};var _setElementCss=function(element,value,vertical=!1)
{var data=css3AnimationIsSupported?(vertical?_generateCssData("transform",value,"translateY(",")"):_generateCssData("transform",value,"translateX(",")")):(vertical?_generateCssData("margin-top",value):_generateCssData("margin-left",value));element.css(data.property,data.value)};var _rePositionVertically=function(){_setElementCss($marqueeWrapper,(o.direction==="up"?containerHeight+"px":"-"+elHeight+"px"),!0)},_rePositionHorizontally=function(){_setElementCss($marqueeWrapper,(o.direction==="left"?containerWidth+"px":"-"+elWidth+"px"))};switch(!0)
...
{case 2:if(animationCss3Str){animationCss3Str=animationName+" "+o.duration/1000+"s "+o.delayBeforeStart/1000+"s "+o.css3easing}
animationCss=_generateAnimationCss((o.direction==="up"?"-"+elHeight+"px":containerHeight+"px"),!0);loopCount++;break;case 3:o.duration=o._completeDuration;if(animationCss3Str){animationName=animationName+"0";keyframeString=$.trim(keyframeString)+"0 ";animationCss3Str=animationName+" "+o.duration/1000+"s 0s infinite "+o.css3easing}
_rePositionVertically();break}
...
animationCss=_generateAnimationCss((o.direction==="left"?"-"+elWidth+"px":0));break;case o.startVisible:switch(loopCount)
{case 2:if(animationCss3Str){animationCss3Str=animationName+" "+o.duration/1000+"s "+o.delayBeforeStart/1000+"s "+o.css3easing}
animationCss=_generateAnimationCss((o.direction==="left"?"-"+elWidth+"px":containerWidth+"px"));loopCount++;break;case 3:o.duration=o._completeDuration;if(animationCss3Str){animationName=animationName+"0";keyframeString=$.trim(keyframeString)+"0 ";animationCss3Str=animationName+" "+o.duration/1000+"s 0s infinite "+o.css3easing}
_rePositionHorizontally();break}
